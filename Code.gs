...
function getOrdersData() {
  ...
  // ATUALIZADO: Agora lê 10 colunas (incluindo Nível de Necessidade)
...
function getAnalyticsData() {
    ...
    // ATUALIZADO: Agora lê 10 colunas
    ...
    // ATUALIZADO: Status agora está na coluna 9 (índice 9)
...
function handleOrderSubmission(data) {
  ...
  data.itens.forEach(item => {
    // ATUALIZADO: Agora salva com o Nível de Necessidade
    // Ordem das colunas: Timestamp, PedidoID, Solicitante, Setor, ID Funcional, Item, Qtd, Justificativa, Nível Necessidade, Status
    pedidos.appendRow([
      timestamp, 
      pedidoId, 
      data.solicitante, 
...
function handleUpdateStatus(data) {
  ...
  // ATUALIZADO: Agora trabalha com 10 colunas
